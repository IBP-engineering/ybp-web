...
<template>
  <div>
    ...
    >
      <UTooltip text="Heading 1" :popper="{ arrow: true, placement: 'top' }">
        <UButton
          :variant="
      ...
      <UTooltip text="Block quote" :popper="{ arrow: true, placement: 'top' }">
        <UButton
    ...
    >
      <EditorContent v-model="editorModel" :editor="editor"> </EditorContent>
    </div>
  </div>
</template>
